...
更新时间：2017-5-10 10:38:23
更新内容： 
        简化updateOne函数的where参数传入规则
        给每个函数加上参数备注
更新人：钟宝森
...
/**
 * mongo插入一条JSON数据
 * @param db     mongo数据库参数   [String]
 * @param table  mongo表名         [String]
 * @param data   插入表中的数据体    [object]
 */
 ...
 * @param db     mongo数据库参数    [String]
 * @param table  mongo表名         [String]
 * @param where  修改条件           [object]
 * @param data   修改数据           [object]
 */
mongo.updateOne = function(db,table,where,data){
    var result = {};
    var fiber = Fiber.current;
